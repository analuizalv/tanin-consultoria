...
const Contato = () => {
  ...
  return (
    <section id="contato" className="py-24 md:py-32" ref={sectionRef}>
      <div className="container mx-auto px-4 md:px-8 max-w-2xl">
        <h2 className="animate-on-scroll font-serif text-3xl md:text-4xl font-semibold text-foreground text-center mb-4">
          Vamos conversar
        </h2>
        <div className="animate-on-scroll stagger-1 mx-auto mb-6 w-12 h-[1px]" style={{ background: "var(--gold)" }} />
        <p className="animate-on-scroll stagger-1 text-center text-muted-foreground mb-12">
          contato@tanin.com.br · São Paulo, Brasil
        </p>

        <form onSubmit={handleSubmit} className="animate-on-scroll stagger-2 space-y-5">
